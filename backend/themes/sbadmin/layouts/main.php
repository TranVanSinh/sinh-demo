...
<head>
    ...
    <link href="<?php echo $this->theme->baseUrl; ?>/css/sb-admin.css" rel="stylesheet">
...
<body>
    ...
    <?php
        ...
        if(!Yii::$app->user->isGuest && Yii::$app->user->can('loginBackend'))
        {
    ?>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="<?php echo Url::to(['site/index']); ?>"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li class="active">
                        <a href="<?php echo Url::to(['home/index']); ?>"><i class="fa fa-fw fa-home"></i> Home</a>
                    </li>
                    <li>
